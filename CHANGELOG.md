...
## [1.0.0](https://github.com/jat10/zaq/compare/v0.17.0...v1.0.0) (2026-09-26)
...
* **Action:** Delete document action ([c3a4a71](https://github.com/jat10/zaq/commit/c3a4a7172aa3a69a401e505217cae54335890da2))
* **action:** expose a workflow and agent action to update message routing rules ([53703ed](https://github.com/jat10/zaq/commit/53703ed09dcc43bece9c0ffc31a52c482eafe9b4))
* **action:** new action to persist message into conversation history ([403a301](https://github.com/jat10/zaq/commit/403a3010a9e385fd5f40b08da5ffb5ad3d2f575b))
* **Actions:** add a new action to notify BO users ([1d6ed08](https://github.com/jat10/zaq/commit/1d6ed088ddcdb62f4c161dc9459c71504aaeb8bf))
* **actions:** add a new action to query whitelisted resources with specific fields exposure for secure access ([e638435](https://github.com/jat10/zaq/commit/e6384354f0f1859dd5c4939653b198c91a704a67))
* **actions:** add the channels config to the query resource tool ([64c34bd](https://github.com/jat10/zaq/commit/64c34bd0cb7c35d8f997c32f9499accf496b6e72))
* **actions:** conver ensure_person schema to ZOI, expose it to the tools registry for agent/skills discovery ([2098dcf](https://github.com/jat10/zaq/commit/2098dcff6b435b4091e8dea0b75d3f13dda5ebb2))
* **Action:** secure http request with configuration, define an http credential provider to leverage auth credentials for authenticated requests ([96a2c60](https://github.com/jat10/zaq/commit/96a2c60c9f4a51c0901ebfb573291c27fe16f053))
* **Actions:** Schedule an action execution ([f496600](https://github.com/jat10/zaq/commit/f4966007ffd34ddb3035c4c49ec0adb67cadc233)), closes [#593](https://github.com/jat10/zaq/issues/593)
* **actions:** update a person info and/or channels with merge ability ([3ce8592](https://github.com/jat10/zaq/commit/3ce85922898d81c8dcf2437ee149287cb1313384))
* add system timezone handling with GMT offset config and timezone-aware rendering ([b171971](https://github.com/jat10/zaq/commit/b1719719c61b5b24027327d931fdb116eade271c))
* **Agent Skills:** migrate custom code to Jido.AI.Skill and support Skill resources ([ca7b695](https://github.com/jat10/zaq/commit/ca7b6959a1634a21ec7837d828d49e5732666ddb))
* **Agent Skill:** support binary resources ([54523f8](https://github.com/jat10/zaq/commit/54523f8522de0ce7ef223093442c2e3206abc38b))
* **agent:** add configurable agent skills with BO management UI ([0c54208](https://github.com/jat10/zaq/commit/0c54208ef32f250004bea2c396306ad9e3c2ab77))
* **agent:** add encode_base64 and decode_base64 tools ([2722408](https://github.com/jat10/zaq/commit/2722408e2e16d67f126b55afe16650b8e4e578f3))
* **agent:** add encode_json and decode_json tools ([9524ae4](https://github.com/jat10/zaq/commit/9524ae4f7b426a8a4f77e9cbd58b0d69f0caf139))
* **agent:** add single-cell sheet updates and integer-coercing increment tool ([96426d2](https://github.com/jat10/zaq/commit/96426d2bfca2f805c07fff6115867663f8a2273d))
* **agent:** add split tool and enrich leads email drafting workflow ([0113a7e](https://github.com/jat10/zaq/commit/0113a7e6d83abdefad9c7a9528e236e21420a2ba))
* **agent:** add web_browsing action bridging the agent-browser CLI ([6c449c4](https://github.com/jat10/zaq/commit/6c449c4489d394932c9b8e71c2ceb7247f85b3b2))
* **agent:** add workflow, people, accounts, and sheets tools with engine edge routing ([c499835](https://github.com/jat10/zaq/commit/c499835fbb0d55cc34bd928d5e82ed87ba12c876))
* **agent:** extract Command runner and add web_browsing verify/timeout ([951352c](https://github.com/jat10/zaq/commit/951352c3bd0269fb99dabe9e632c45e07ad1313f))
* **agent:** isolate run_agent per workflow run/step and forward actor ([d07af39](https://github.com/jat10/zaq/commit/d07af39e8677323109a29ff199bee9e0d65da997))
* **agent:** let run_agent carry context turns and token budget to the agent ([19fddac](https://github.com/jat10/zaq/commit/19fddacff58073c44833bffecc418232ed018b4d))
* **agent:** make dispatch_event a usable tool with optional input, destination, and cascade forwarding ([aea8d8b](https://github.com/jat10/zaq/commit/aea8d8bc1ee4e1755d30e027d33304f23658a0cc))
* **agent:** pass enriched retrieval context (zaq-fuu.2) ([a6677f4](https://github.com/jat10/zaq/commit/a6677f4a68fea061c2d80009043427c136afa6b4))
* **agent:** rebuild skills on progressive disclosure with load_skill tool ([7a5b74c](https://github.com/jat10/zaq/commit/7a5b74ccd3dfb595cbbacad0856b9798202df7e9))
* **agent:** support base64 files and canonical folders ([75392d9](https://github.com/jat10/zaq/commit/75392d9ec9f91bd75ca7f85c87bda95835cdcc43))
* **agent:** support list concatenation and cascade-aware placeholders in concat ([e659237](https://github.com/jat10/zaq/commit/e659237f41e92941963c962c8a9b2704b88140e0))
* **agent:** unify conversation history to role/content vocabulary ([472b2d3](https://github.com/jat10/zaq/commit/472b2d31f4e19a4f11c82c8d8885fc0d8fcfad92))
* **agent:** wire trusted identity into fetch_history conversation recall ([19ce3fa](https://github.com/jat10/zaq/commit/19ce3fa5a93833aad793011e45e6fcb564c7a86c))
* **AI provider:** support ChatGPT Plus and Pro subscriptions [[#590](https://github.com/jat10/zaq/issues/590)](https://github.com/www-zaq-ai/zaq/issues/590) ([67f49ea](https://github.com/jat10/zaq/commit/67f49ea7fb3b263fd99bcc7195a256447ff37887))
* **auth:** uplift OAuth callback result page ([b814418](https://github.com/jat10/zaq/commit/b814418797e6a1a152b791830775e84b359ef129))
* **bo:** add DesignSystem.StatusDot for active/inactive and count badges ([a81f588](https://github.com/jat10/zaq/commit/a81f58800f43dcdd0a9f43b10ba7ab45e354fa84))
* **bo:** add table selection bar and migrate workflows list to DS table ([f493e31](https://github.com/jat10/zaq/commit/f493e31a0edf551d04081a840ce65190c17543f2))
* **bo:** add table selection bar and migrate workflows list to DS table ([dfc7cfe](https://github.com/jat10/zaq/commit/dfc7cfed945a3d9cfd4865d764d35ec217b73b36))
* **bo:** manage disk provider volumes ([237f76b](https://github.com/jat10/zaq/commit/237f76b0200934ed42c16ac3e878710ae9707b84))
* **bo:** unify history feedback modal with chat ([b238dd7](https://github.com/jat10/zaq/commit/b238dd76603d1edd65ccb34e7b9b7738abb9fcde))
* **channels, workflow:** enable workflow on communication channel messages ([502b5a8](https://github.com/jat10/zaq/commit/502b5a8f47639d4cb064bc56e9852577ae46cd6f))
* **channels:** add actionable credential recovery links ([49876ee](https://github.com/jat10/zaq/commit/49876ee23729037c71eae44abb6b3582160e2e10))
* **channels:** add disk data-source bridge over ingestion volumes ([4f95fec](https://github.com/jat10/zaq/commit/4f95fec4b7e7c24914f7951b186cef5c34c21605))
* **channels:** add http_request action and general.http_request tool ([fba4659](https://github.com/jat10/zaq/commit/fba46593ced57b77feb5d515a78248cd391767bb))
* **channels:** deliver telegram messages as rich markdown for table support ([27000f6](https://github.com/jat10/zaq/commit/27000f63341d2f03036633cac36a7028e16c7742))
* **channels:** route incoming messages to agent or simply fire an event with no-op - [channels]: trigger a workflow ([10be048](https://github.com/jat10/zaq/commit/10be04826c8420c7e2e86e59563bf238d66866bc)), closes [#503](https://github.com/jat10/zaq/issues/503)
* **channels:** scope disk bridge operations to channel configs ([94191b2](https://github.com/jat10/zaq/commit/94191b2a36985b0850340989b4a41a82b5712324))
* **contracts:** add materializing_event to record, excluded from json ([1fa22d0](https://github.com/jat10/zaq/commit/1fa22d0624ad8fe6a97036223ff3bf90236b7a99))
* convert reactions to feedback rating ([cfd9481](https://github.com/jat10/zaq/commit/cfd9481244aa48efe256b4d084d1e207221a43c5))
* **credentials:** groundwork to enable people's personal grants ([a3a6492](https://github.com/jat10/zaq/commit/a3a6492f37e30de14a620c36820480ff3089c537))
* **credentials:** invalidate agent runtimes on auth changes ([59cb0d4](https://github.com/jat10/zaq/commit/59cb0d4946fc45298cfc6215d90c51c7d6c881d2))
* **credentials:** migrate AI providers to Connect grants ([37f548f](https://github.com/jat10/zaq/commit/37f548fd8f39910b5d17cbaf6030c26512593dca))
* **credentials:** migrate AI providers to Connect grants ([1e83086](https://github.com/jat10/zaq/commit/1e830863b17dcd0e858cff61f2bba16952f3590f))
* **credentials:** UI to administer personal policy and provide personal grants ([e275b68](https://github.com/jat10/zaq/commit/e275b6806fb82918d90b92de1fe3a0ccaeec37a8))
* **data source:** add a watcher to data sources - phase 4 [Ingestion] Generic UI for external Data Sources ([fa6ad61](https://github.com/jat10/zaq/commit/fa6ad611beb781c2419f71261050a09195abf196)), closes [#486](https://github.com/jat10/zaq/issues/486)
* **data source:** add permission update action (zaq-mc1) ([31d69c1](https://github.com/jat10/zaq/commit/31d69c11dcd960fe8b0d33b239447671c91cb58d))
* **data source:** connect data source to ingestion pipeline ([135f8ea](https://github.com/jat10/zaq/commit/135f8ea8bdcbcfe310378d3f58938f00d3d1bf4e))
* **data source:** enforce external data sources with provider's permissions and person's identity ([f05a55b](https://github.com/jat10/zaq/commit/f05a55b50b167345eb201519908fd96641d610c0))
* **dba:** add container provisioning with safe restarts (zaq-f6s) ([d702999](https://github.com/jat10/zaq/commit/d70299993ccb1eb3db2960d85094303d6213d4a4))
* **dba:** automate developer extension setup (zaq-f6s.9) ([116a003](https://github.com/jat10/zaq/commit/116a0035b4df3d249ea54ec1e8d59008f913aa93))
* **dba:** bootstrap databases and restricted credentials (zaq-1yh) ([6dd4d9c](https://github.com/jat10/zaq/commit/6dd4d9cc95cb32511e2d29936cb68d0beccdf532))
* **ds:** generalize Toggle for multi-choice segmented control ([e359efe](https://github.com/jat10/zaq/commit/e359efe2f5f6a9b2d8a99a3a4e32fcbf1edc059e))
* **engine:** add "incomplete" run status for pruned-terminal workflows ([3bc5861](https://github.com/jat10/zaq/commit/3bc5861d99d7c99c8b9ac4d0ccd4211aae78df8d))
* **engine:** add cron trigger scheduling with DynamicCron and worker ([184f7ce](https://github.com/jat10/zaq/commit/184f7cee25d8a387d6a71816d172345a158219d2))
* **engine:** add date/datetime comparison support to workflow conditions ([525c838](https://github.com/jat10/zaq/commit/525c8387c22e1d70ee5ec81aea999f680c172441))
* **engine:** add map iteration primitive, migrate Batch onto it, drop Iterate ([2df07c6](https://github.com/jat10/zaq/commit/2df07c64cfa36e3690308fa78410a5e43b9754ff))
* **engine:** add workflow composition primitive and map node type ([336e185](https://github.com/jat10/zaq/commit/336e185f9db552e0d52fa93d8487a695edc3ad95))
* **engine:** add workflow node behaviour and in-memory prepared run DAG ([59e8af5](https://github.com/jat10/zaq/commit/59e8af54a0a37a7eaec6592c3d8fa53495ac3c89))
* **engine:** distinguish graceful shutdown from crash on workflow runs ([8404e43](https://github.com/jat10/zaq/commit/8404e43cc7f663109acff8f7032598cc1e18acdb))
* **engine:** support optional trigger on workflow import ([c2fb0a7](https://github.com/jat10/zaq/commit/c2fb0a758943271008cc672fc88eb653c05b72d1))
* **engine:** thread proactive emails via RFC Message-ID and In-Reply-To ([1a65d04](https://github.com/jat10/zaq/commit/1a65d0423e545f123576c993cc87af9c2bc5da1c))
* **engine:** validate edge endpoints and connectivity in composition ([6d9a478](https://github.com/jat10/zaq/commit/6d9a478330bebd15eebb02de5afb26da1a481eb4))
* **engine:** validate workflows at save and run prepared DAGs ([b2dd8cd](https://github.com/jat10/zaq/commit/b2dd8cdd830e737c03a92d0a9dfcb5f0cd7b9120))
* **imap:** support attachments in incoming emails ([029d59a](https://github.com/jat10/zaq/commit/029d59a2c366507b3893d058d1e1c2645e4d1384))
* **ingestion:** browse and preview materialized provider records ([43adafe](https://github.com/jat10/zaq/commit/43adafe2f1967bcc496cc0159a33a8375fe0d056))
* **Ingestion:** Make Data sources files list accessible through the ingestion page ([9eb90ee](https://github.com/jat10/zaq/commit/9eb90eec75011e657524f0d5897eb2ac9ce5befb))
* **ingestion:** replace metadata column mirrors with source locators ([5183c47](https://github.com/jat10/zaq/commit/5183c47263b1d25d53ae7f479620bd64bacd5e3b))
* **live:** add markdown editor, skill mcp endpoints, unify bo tables ([e92ef0b](https://github.com/jat10/zaq/commit/e92ef0b8fb8811ddf5ad9e7416dd8cf49bf38e49))
* **live:** add skill resource uploads backed by ingestion volumes ([c11dd04](https://github.com/jat10/zaq/commit/c11dd049c602d8213064ef29a971b0a8d82a83d8))
* **live:** add virtual start origin node with trigger input card to run view ([29f9d3b](https://github.com/jat10/zaq/commit/29f9d3b9cfd9a8508249e303e5eafc437862219a))
* **live:** cap skill resource uploads and inline the resources panel ([185047d](https://github.com/jat10/zaq/commit/185047d7047e30bae7c148bb02ca51211d2fdf86))
* **live:** render agent info and type badges in workflow dag nodes ([7ba295b](https://github.com/jat10/zaq/commit/7ba295b7aa3a7839b9fc201a5822358724b27063))
* **media:** Receive media from channels and relay to agent with proper logs ([342d6eb](https://github.com/jat10/zaq/commit/342d6eb125a192bf24205de02be56025838022fc))
* **message_routing:** enable person based message routing ([7a788c5](https://github.com/jat10/zaq/commit/7a788c5005221ba3e85e2bbf900b652e6b7c615f))
* **people:** add filter-scoped cross-page selection (zaq-iz2) ([aeea987](https://github.com/jat10/zaq/commit/aeea987bc759164000c2c9650fbcf72dda4be593))
* **people:** add OTP authentication backend and revocable sessions ([8648b9d](https://github.com/jat10/zaq/commit/8648b9d4683cdd802b941d74f0a2fa396e4eb320))
* **people:** add OTP authentication backend and revocable sessions ([f187d99](https://github.com/jat10/zaq/commit/f187d99f5ed7241ddf7a46229da012395a7494a3))
* **people:** add OTP authentication backend and revocable sessions ([d7f4688](https://github.com/jat10/zaq/commit/d7f46889886ceae8cb8cbc3371fea1518d4b5b1b))
* **people:** administer people sessions via BO ([d84c917](https://github.com/jat10/zaq/commit/d84c917c4828811c6a88e27054cf00fcd1e15404))
* **People:** Authentication flow with UI ([db15209](https://github.com/jat10/zaq/commit/db152098356ebff535095a76e2d99fead25a3de2))
* **People:** Authentication flow with UI ([f623991](https://github.com/jat10/zaq/commit/f62399132cf76e95d546429a9dfb4d22f75aa933))
* **people:** bo access security settings ([4ee52be](https://github.com/jat10/zaq/commit/4ee52be0f4ecba85be74dd4028bba74394c84276))
* **People:** Conversations list and details with sharing ability for people with permissions ([e7ebb7c](https://github.com/jat10/zaq/commit/e7ebb7cd970b0c882ecba794486cca6726295dee))
* **people:** enable dedicate people permission layer ([ff07444](https://github.com/jat10/zaq/commit/ff07444ed35bd10223ebfcdf22006767f6dca53a))
* **people:** enable dedicate people permission layer ([ab3e5f3](https://github.com/jat10/zaq/commit/ab3e5f3755869da90e3e09e2dac533b91a75a6dc))
* **people:** enable dedicate people permission layer ([6114b2e](https://github.com/jat10/zaq/commit/6114b2e09598f64b65a0243e5ab58815b5bec948))
* **people:** enhance people self service pages UX and UI ([845ed3c](https://github.com/jat10/zaq/commit/845ed3c6df85c456950ea7975bbf0e9c26608b63))
* **People:** People profile page with edit controls ([f23f69d](https://github.com/jat10/zaq/commit/f23f69d57572f2360569c9c335c0d79a6cf89c19))
* **people:** preserve destinations through login (zaq-ba7) ([e8b02e7](https://github.com/jat10/zaq/commit/e8b02e75fa086934a9bd1d52e30c544942ce2841))
* **people:** redesign profile and add atomic channel ordering ([25415b5](https://github.com/jat10/zaq/commit/25415b566626f6b7bd3971283bff516b3678fb82))
* **retrieval:** enrich chunk context (zaq-fuu.1) ([cf0932a](https://github.com/jat10/zaq/commit/cf0932a73e0f73210f5b143abdea10d24054eeb6))
* **storage:** persist disk volumes in channel configuration ([987e791](https://github.com/jat10/zaq/commit/987e791b9cb9bcb3fc6fccdc4a180335c0818dfb))
* **telemetry:** add agent LLM usage granularity (zaq-uy9.3) ([a660185](https://github.com/jat10/zaq/commit/a660185aca2d3295f61771e8c0ab269f5a588a15))
* **web:** surface agent traces on workflow run step cards ([875472d](https://github.com/jat10/zaq/commit/875472d936fe57fe26123d131b6812a82ed73e25))
* **workflows:** make condition halt failures human-readable in run view ([6f4cfa7](https://github.com/jat10/zaq/commit/6f4cfa7b5b44918b14704f743d9f8b7f5519b635))
* **workflows:** support jsonc imports and fixes [#513](https://github.com/jat10/zaq/issues/513) ([da4e125](https://github.com/jat10/zaq/commit/da4e1253275751be94582806f53f461f3188f2db))


### Bug Fixes

* **action:** add metadata when loading history messages ([de01e43](https://github.com/jat10/zaq/commit/de01e430bdaaed2d34f4e431f3d8d004635e2821))
* **action:** correctly extracting rows with trailing headers and empty values - fixes [#515](https://github.com/jat10/zaq/issues/515) ([70179e0](https://github.com/jat10/zaq/commit/70179e02439619aa4e535b9e7ee5ca67df7de928))
* **actions:** add metadata about headers information in extract_rows - fixes [#512](https://github.com/jat10/zaq/issues/512) ([681d767](https://github.com/jat10/zaq/commit/681d767705985ceedf784a0a7e5c97b151bf4204))
* **actions:** delegate increment action to jido_action catalog ([afe70a2](https://github.com/jat10/zaq/commit/afe70a2aaa1ac6deb159b7c8f041dade669b8576))
* **agent:** address review comments for web_browsing action ([c484803](https://github.com/jat10/zaq/commit/c484803ba68272279c042ed433b15facd03e40b8))
* **agent:** address skills and fix model dropdown positioning ([59dcf47](https://github.com/jat10/zaq/commit/59dcf4717b7376131ff9f82c6372a278cda2c373))
* **agent:** allow private skill resource loading ([68aad62](https://github.com/jat10/zaq/commit/68aad620231ea2e1305ce4837a175fc92bde0b74))
* **agent:** enable LuaEval with Lua runtime dependency ([8c6f12d](https://github.com/jat10/zaq/commit/8c6f12ddb70acb086806cb583e668e2a6cee9d9f))
* **agent:** enforce context_max_size token budget on seeded context ([c400990](https://github.com/jat10/zaq/commit/c4009902b60031861146a7b576a76dd42e251c24))
* **Agent:** enforce model max context size per turn ([8c77be5](https://github.com/jat10/zaq/commit/8c77be5232c0f0da6936d9d60a1a9f0b084838d9))
* **agent:** handle binary content in context estimation ([794bbb5](https://github.com/jat10/zaq/commit/794bbb517c7f56c97f72cf804ef4139ac67d642e))
* **agent:** lifecycle unified identity ([2f9f2a7](https://github.com/jat10/zaq/commit/2f9f2a7f9866a5ac5cb92102da63d4104be68832))
* **agent:** map incomplete provider responses to unavailable message ([1ffe405](https://github.com/jat10/zaq/commit/1ffe405c161ef7f41739e239831a9cde9f923b88))
* **Agent:** pass max context cfg to legacy answering agent ([966db9b](https://github.com/jat10/zaq/commit/966db9b819de54cd022cf33c62f44caf53539061))
* **agent:** preserve runtime credential dispatch seam (zaq-jrg.54) ([9522e21](https://github.com/jat10/zaq/commit/9522e21ae07edd8b50677141020bd71de79b5955))
* **agent:** prevent filesystem discovery for DB-backed skills ([6691e54](https://github.com/jat10/zaq/commit/6691e54f02e055e8c81ecfd6113f4b50fd88139a))
* **agent:** register zaq_router as real ReqLLM provider and gate its models on auth ([fc0b014](https://github.com/jat10/zaq/commit/fc0b0148454bba9d914e897a407f21d4e5e1eb94))
* **agent:** reject invalid lifecycle actor fallback (zaq-yws) ([ffb3ed7](https://github.com/jat10/zaq/commit/ffb3ed761889dbab5929b3580efe03ffd9b7a16f))
* **agent:** reject lossy skill body whitespace (zaq-gsq) ([a846262](https://github.com/jat10/zaq/commit/a8462624febef7ac8baf1138314d5167800a2bac))
* **agent:** resolve skill resources by exact name ([f1446a2](https://github.com/jat10/zaq/commit/f1446a228e9a124d35489be0f784e23a620595d7))
* **agent:** route RunAgent to executor and authorize machine runs ([42b599a](https://github.com/jat10/zaq/commit/42b599a82359507e672018832fd234896ce9141c))
* **agents:** support for custom AI provider in configured agents ([86fc397](https://github.com/jat10/zaq/commit/86fc39707c200b190458a4d928580615dde9acdf))
* **agent:** update factory to honor tool timeout param per turn ([aec7412](https://github.com/jat10/zaq/commit/aec741235120f9f91095c4dd8d474c76c80b1f81))
* **agent:** update tool module refs to namespaced paths and sync tests ([2198ee0](https://github.com/jat10/zaq/commit/2198ee00b52a41e36ee2ee4547c263339450fbb6))
* **authorization:** resolve current people and reject stale team access ([e6ad2ca](https://github.com/jat10/zaq/commit/e6ad2ca758e7b837cc49168e4b85cd3f60f9e9d7))
* **bo:** cache missing system timezone (zaq-k1y) ([0e706ff](https://github.com/jat10/zaq/commit/0e706ff4e64ea6aad045920c8adf9a9fc9b2c988))
* **bo:** default input value assign to nil when omitted ([1cc3a73](https://github.com/jat10/zaq/commit/1cc3a73515d6fc9701d27a76e590d78490ea76f0))
* **bo:** handle ingestion upload errors in consume callback ([6e240b1](https://github.com/jat10/zaq/commit/6e240b17a907884a1223c83a6467f3dd1393f021))
* **bo:** show bulk action bar when raw is selected and adjust history test ([0cf1220](https://github.com/jat10/zaq/commit/0cf1220c58ece7b770c2c4f5b44a899585a4ffe8))
* **bo:** stop saved feedback note overlapping action buttons ([1a90dfc](https://github.com/jat10/zaq/commit/1a90dfce102ebacb7fb1bcfe9f116ebd9e512bc0))
* **browser:** select native runtime and add launch diagnostics (zaq-5j6.9) ([47c2028](https://github.com/jat10/zaq/commit/47c20287333bdda92f2777985a575eadb1174267))
* **card:** assign unique dom id to component ([9128a5e](https://github.com/jat10/zaq/commit/9128a5efef21a721e99bf5ed331344d64f7d47bf))
* **channels:** bootstrap email sub-provider configs on cold start ([3ad598e](https://github.com/jat10/zaq/commit/3ad598e47ccf7c5d0248c6e66d9f6ef7c0fa442b))
* **channels:** default nil message_format to markdown so it stamps a format ([84a4c7f](https://github.com/jat10/zaq/commit/84a4c7fd06e265717071dbf92c1de6add1e63133))
* **channels:** normalise sub-providers so imap replies convert markdown to html ([f2ea258](https://github.com/jat10/zaq/commit/f2ea258898bf0566e49d605999b2f29efafa6cef))
* **channels:** repair reaction ingress across telegram and mattermost ([b9e3a6b](https://github.com/jat10/zaq/commit/b9e3a6be73dfeeb941e27f2b81255155b7c760cf))
* **channels:** route People portal URL lookup through Engine (zaq-jrg.53) ([c60eada](https://github.com/jat10/zaq/commit/c60eadaeb280dbf959c6c5cd4fd29eff6f690e74))
* **channels:** route thread replies by root author (zaq-s14) ([a508f64](https://github.com/jat10/zaq/commit/a508f6463444b4475e607eaba250c4f9eef5708e))
* **channels:** stamp :markdown format so telegram renders rich messages ([e51b2b6](https://github.com/jat10/zaq/commit/e51b2b6cb2612e1604c1a1200a265480c950372e))
* **channels:** support Mattermost skin-tone reactions ([982d68a](https://github.com/jat10/zaq/commit/982d68a7eeb26c52163a1b8db80dc7fa04cc3d62))
* **channels:** use provider roots and canonical folder ids for browsing ([840f629](https://github.com/jat10/zaq/commit/840f6291d0384677796bb77644a6f8a46a58a2c8))
* **chore:** install firefox and webkit browsers on cached e2e runs ([8a804cb](https://github.com/jat10/zaq/commit/8a804cbff348137b4b09449634284adfd906f34a))
* **ci:** propagate fork coverage failures ([f917463](https://github.com/jat10/zaq/commit/f917463b0197240661c97b2a79287c0edfc85e25))
* **ci:** rebuild LiveView to enforce session log filtering ([a0ca270](https://github.com/jat10/zaq/commit/a0ca270562a89dd7ec3263603f1d59beb1011c89))
* **credential:** safely surface refresh token errors, tighten concurrent tests ([ac92e52](https://github.com/jat10/zaq/commit/ac92e5240bc1f92b5d9e74107104338788ef4eab))
* **credentials:** collect composite data-source scopes (zaq-hil) ([30f9588](https://github.com/jat10/zaq/commit/30f958882726ff5b4d23a821bbaf2dff170b35d5))
* **credentials:** harden provider resolution (zaq-vuo.5) ([b7fc850](https://github.com/jat10/zaq/commit/b7fc85040fb1b7affc7f1a5cc0aa2fb948eb0b4c))
* **credentials:** migration and refresh fixes ([cb01ff6](https://github.com/jat10/zaq/commit/cb01ff65d8800bfb14d00c9fc2ea07e5f2202ea9))
* **credentials:** route global consumers through Engine (zaq-jrg.52) ([294f1b9](https://github.com/jat10/zaq/commit/294f1b9ec5d1c8431019d74675ac21ccc236a1f4))
* **credentials:** route runtime resolution through Engine (zaq-jrg.51) ([f315f6b](https://github.com/jat10/zaq/commit/f315f6b299c38df813fd26c7e8b3f59fa5d71d4b))
* **Data source:** get document on google drive use valid field mask ([623088e](https://github.com/jat10/zaq/commit/623088e516d459a37248f00238e0ba9e2151b776))
* **data source:** seal watched records to make them safe for materialization ([2405f45](https://github.com/jat10/zaq/commit/2405f456fa0ff8af604a36b21e12a01479f37a2a))
* **datasource:** normalize parent_id to jido_connector when creating documents ([7d17e85](https://github.com/jat10/zaq/commit/7d17e85f27e6c4c711c476d62f220775fa8ec01c))
* **e2e:** clean up Connect credentials during E2E reset ([74d537d](https://github.com/jat10/zaq/commit/74d537d1b349815d25e0c86ff59f544c291a2de3))
* **e2e:** history detail page is now open on clicking the raw of the table and not the view link ([3a06c5d](https://github.com/jat10/zaq/commit/3a06c5d7649f3ad22b0446bfc52f0937331bf5db))
* **e2e:** login initial browsing session per env. ([13c0ef1](https://github.com/jat10/zaq/commit/13c0ef137864d75cda33985087964996e26f0eca))
* **e2e:** remove duplicate test blocks ([c07186e](https://github.com/jat10/zaq/commit/c07186e34821782e65f7ba2106770700ae784d92))
* **e2e:** stabilize async ingestion waits without drawer auto-open ([7c1edac](https://github.com/jat10/zaq/commit/7c1edacfdaff64e61d5c486bb72c1a37808f17ce))
* **e2e:** target drawer Cancel button in agents cancel test ([db9de74](https://github.com/jat10/zaq/commit/db9de7462d4732efe1cce0c53499d36987841f34))
* **e2e:** test ingestionStarted no longer waits for "Monitor jobs (1 active)  it now checks: "Ingestion started." toast appears. ([ef23f70](https://github.com/jat10/zaq/commit/ef23f70aadf0b328d557ffb6a7c0f50aadc269c2))
* **email:** [Channels] Communication email from name is not respected ([4ae0beb](https://github.com/jat10/zaq/commit/4ae0beb0f879d3d1af716c4500d896799e11f3c3)), closes [#600](https://github.com/jat10/zaq/issues/600)
* **email:** include subjet into Message.Incoming content for agents and conversation history ([8e06ccb](https://github.com/jat10/zaq/commit/8e06ccbcf85b67d80919746376f1b1a5ac54bd9a))
* **engine :** Unify email threading around stored conversation anchors ([3aff7ec](https://github.com/jat10/zaq/commit/3aff7ece73d770241da09703b6bdb63185f3ddc5))
* **engine:** auto-recover orphaned workflow runs on driver death ([5f6776d](https://github.com/jat10/zaq/commit/5f6776dc61094ef34455083ad08525ed8cb55a64))
* **engine:** capture real reason for orphaned workflow step failures ([3982a91](https://github.com/jat10/zaq/commit/3982a917a5a59a564a78f588a599048225b5f102))
* **engine:** handle "incomplete" status in broadcast and interrupt guards ([9af8b36](https://github.com/jat10/zaq/commit/9af8b360ceb5274417646e71b4b50ab55a1ff3f4))
* **engine:** make pause_run immediate — kill agent, freeze step_run duration, broadcast updates ([7fac7a8](https://github.com/jat10/zaq/commit/7fac7a8feeefc576af3f5700c4aa593d3edb51f6))
* **engine:** make workflow event dispatch and triggering reliable ([e42761a](https://github.com/jat10/zaq/commit/e42761a11c6a04615f62dcbfc4b5e9f95ffbdfa1))
* **engine:** pass structs through edges, fail runs on edge crashes ([f0efa81](https://github.com/jat10/zaq/commit/f0efa81441f8f01bf2c0525af0b1da415800447b))
* **engine:** record email threading anchor on the notification log ([132df7f](https://github.com/jat10/zaq/commit/132df7fd2b172d51286814676954fca270c8b768))
* **engine:** remove run trace and split tool ([78ff2f7](https://github.com/jat10/zaq/commit/78ff2f7ea40ed3f6f7c8a4cdfaf93ebd405b5c32))
* **engine:** run each batch iteration fully before the next fans out ([f81a1b0](https://github.com/jat10/zaq/commit/f81a1b08f52053b8fe89612dd2cbe75f46e409b1))
* **engine:** scope shutdown sweep to local runs and harden async launch and fact lookup ([d1a1e13](https://github.com/jat10/zaq/commit/d1a1e139713773673e5cb88d6e652eabcfadfb1a))
* **google drive:** connect the new file upload action ([ad34aec](https://github.com/jat10/zaq/commit/ad34aec4c5e836da08bf50a7f4cbbe5625b7f719))
* **identity:** normalize channel identities and enforce uniqueness ([0dcb03b](https://github.com/jat10/zaq/commit/0dcb03bb1b49038568c57e2f2f26c7404234417d))
* include missing state.ex changes ([f8ad846](https://github.com/jat10/zaq/commit/f8ad846b450a03b63e69c28c574f72dd4f3b66a9))
* **Ingestion UI:** wiring to data source gaps ([613cd3b](https://github.com/jat10/zaq/commit/613cd3b2bb9241f6d670e8b94eeb4f0d79439073))
* **ingestion:** Action icons hover over file name instead of next to it ([49e4c92](https://github.com/jat10/zaq/commit/49e4c92ba2640f1ae249de1616feae31b1f07416))
* **ingestion:** diagnose rejected watch records ([33a6562](https://github.com/jat10/zaq/commit/33a65624de05e8a5639c1331080fc063e7a527cc))
* **ingestion:** empty state when no data source is enabled, keep ingestion async for now and remove related controls from ui ([6553d44](https://github.com/jat10/zaq/commit/6553d44a802334d604e24eb66487dfdb86a3b2aa))
* **ingestion:** keep runtime dependencies out of persisted jobs ([dfddd6d](https://github.com/jat10/zaq/commit/dfddd6d6e403c414c40c2103e0628501983e25d2))
* **ingestion:** keep table header when packing rows with empty entries ([431d7d3](https://github.com/jat10/zaq/commit/431d7d31b9dbbe9a3b3c4be99570feb28c917577))
* **ingestion:** pack section chunks by path and add source locators ([7e9acae](https://github.com/jat10/zaq/commit/7e9acae9bbc928c98e6a54004a7c07f7f9ecb9b5))
* **ingestion:** preserve materialization actor context ([97d9f4f](https://github.com/jat10/zaq/commit/97d9f4f56cce8dfb15d985b41a74dff095d11ed5))
* **ingestion:** provide wider space for the filename so it is always visible and clickable ([02eee6c](https://github.com/jat10/zaq/commit/02eee6ca06d84f0a083b44ac79411cbfdf96ea0a))
* **ingestion:** refresh file browser after async ingest enqueue ([a17bdce](https://github.com/jat10/zaq/commit/a17bdce6a5e68e80fd27ef225aaf194361037d8e))
* **ingestion:** show ingest success as overlay toast above jobs drawer ([6655000](https://github.com/jat10/zaq/commit/66550000809c96cc9925608fdb04a4b93273d423))
* **ingestion:** store chunks verbatim, embed section-path context ([fe8a995](https://github.com/jat10/zaq/commit/fe8a995994b2ff1c79ba17c5566ffd81942dd203))
* **live:** prevent inline team-create from crashing assign_team_select ([060358b](https://github.com/jat10/zaq/commit/060358b14d5679a69ed1957b2e7e550c2dddac02))
* **live:** run workflows off-channel to survive duplicate_join interrupt ([b1294f8](https://github.com/jat10/zaq/commit/b1294f837ebdce344ce48c0482163d9e0b9e5065))
* **merge:** consolidate people atomically and preserve identity history ([f96b811](https://github.com/jat10/zaq/commit/f96b8114befb7b26ea7cbbd83ac46d3c9478322e))
* **migration:** normalize legacy identities with rollback and replay coverage ([66d0aa6](https://github.com/jat10/zaq/commit/66d0aa610b2ed365850e6334019e84bc0324d793))
* **migrations:** renumber threading migration to resolve version collision ([612869d](https://github.com/jat10/zaq/commit/612869d6bfd42d3e7c2a21eff356fc88f26a874c))
* **notification:** ability to send DM to channels [Action] Notify person is not honoring priorities ([eac2c78](https://github.com/jat10/zaq/commit/eac2c78a7795fd3efc6e2e7ccf22bbcae56f3aaf)), closes [#524](https://github.com/jat10/zaq/issues/524)
* **notification:** align email:smtp and email:imap for one single config path - [Action] Send notification message formatting is skipped ([f959525](https://github.com/jat10/zaq/commit/f95952502c2496645c58cb6852bdf244ba19c384)), closes [#547](https://github.com/jat10/zaq/issues/547)
* **people:** correct shared layout and auth hook expectations ([9c17b64](https://github.com/jat10/zaq/commit/9c17b64a3c5275659a127b36a8d56eb1023833a3))
* **people:** isolate feature hook registration (zaq-msu) ([ca80e0a](https://github.com/jat10/zaq/commit/ca80e0ac815736d1e0b7630658268f5d32a71156))
* **people:** remove all people use Everyone instead, apply badge for people's status field ([f460855](https://github.com/jat10/zaq/commit/f460855b3f0d890550ce004d6195de68506857dc))
* **people:** unify settings menu entries ([e30b5db](https://github.com/jat10/zaq/commit/e30b5dbcfae9b6cea6333911486b7ee622548668))
* **Rate Limit:** adhere to new pubsub metadata shape ([6f1c9f6](https://github.com/jat10/zaq/commit/6f1c9f6aaa3e7624e4f809fed875fc6e8bd17140))
* **skills:** resolve uploads from current resource locations ([f862f7d](https://github.com/jat10/zaq/commit/f862f7d697d1136e1463f2058471eaa11a9adf10))
* **Slack:** icon dimension ([ee18585](https://github.com/jat10/zaq/commit/ee18585a862f6b9aa3d80012b3fb264ce69b0f71))
* **storage:** align storage with existing data source actions for search, list and create documents ([0516fd3](https://github.com/jat10/zaq/commit/0516fd384578134cfb11a4874a145137f54711ff))
* **storage:** enforce permissions on edit, move and delete documents ([1f607a2](https://github.com/jat10/zaq/commit/1f607a2774f0e59fdbed92588f8b250e9ca7a6a7))
* **storage:** honor search paths and verify disk agent flow ([268298e](https://github.com/jat10/zaq/commit/268298ecc16440ed62c69492c9cf2224feccb69a))
* **storage:** propagate actors and enforce disk entry permissions ([dbeaf34](https://github.com/jat10/zaq/commit/dbeaf34e4044cb392a58cd717baa2f08e4fe3120))
* **storage:** properly count entry principals ([c633b70](https://github.com/jat10/zaq/commit/c633b70576b06ecc19afd529f1ce58d6e948d9c2))
* **storage:** reject sibling path-prefix escapes ([8d14a12](https://github.com/jat10/zaq/commit/8d14a12658b092438801fa45da8dac9255c57a29))
* **storage:** resolve decomposed Unicode paths (zaq-lcj) ([7e9ad87](https://github.com/jat10/zaq/commit/7e9ad872153522590d158949b05aa2f7d8f80759))
* **test:** eliminate suite warnings ([4e40503](https://github.com/jat10/zaq/commit/4e40503eb495fa2fee9c65a682c17ad9df0732bb))
* **test:** format wait_for_idle_server guard clause ([78580a2](https://github.com/jat10/zaq/commit/78580a2f4f2f4c9a76936573c5c19b7b6ad2bf1b))
* **test:** isolate batch trigger concurrency spec from PubSub pollution ([cbe6f27](https://github.com/jat10/zaq/commit/cbe6f276e8c5ab3a339e5b268a5161b7fb43a88e))
* **test:** stabilize agent delete and IMAP listener sink error tests ([fbea05c](https://github.com/jat10/zaq/commit/fbea05c0a15c238d33112881cbab4fa97166270b))
* **test:** stabilize NodeRouterMock stub in batch trigger integration test ([0a026a8](https://github.com/jat10/zaq/commit/0a026a8f92f816a2b596952edece6223501b8972))
* **test:** target modal header close in AI credential modal test ([af1e470](https://github.com/jat10/zaq/commit/af1e4709cc5744b95f41b3f3cc8d3cad275527f9))
* **ui:** compact list selection controls (zaq-4v4) ([eeae929](https://github.com/jat10/zaq/commit/eeae929e25277ced7463a2a2232e5b3aa6ee4ccd))
* **ui:** compute flash clear JS after default id is assigned ([d5e2590](https://github.com/jat10/zaq/commit/d5e25905fe70de9e953618a8b502aa4d327d2f0f))
* **UI:** regression on input ([f1d3c6e](https://github.com/jat10/zaq/commit/f1d3c6e5c667b394aa9f10f08d24a98aac4e2189))
* **ui:** self-host design system fonts ([8b3a4d9](https://github.com/jat10/zaq/commit/8b3a4d98b4d0d44da57542fd169d5b9b60d0723e))
* **ui:** stabilize select dropdown sizing and panel positioning ([b44e4f1](https://github.com/jat10/zaq/commit/b44e4f1aa7f3213d0558235761df9be711dcf329))
* **Utils:** Map Utils read_any/2 carry false as a value not as nil ([2bf9f4d](https://github.com/jat10/zaq/commit/2bf9f4d066819b7bd5961c869b795ef190682cb0))
* **web:** make conversation history table and filters responsive ([1dff5ef](https://github.com/jat10/zaq/commit/1dff5ef5bd8379020349717c69c34a12e26773be))
* **workflow:** adjust channel message event name ([f2d2264](https://github.com/jat10/zaq/commit/f2d2264438f31a43e200f720b160d6799a8e7699))
* **workflow:** remove phantom Iterate marker for explicit Batch delivery ([5eb3d91](https://github.com/jat10/zaq/commit/5eb3d912d2aebaf2561e8450c3ac01ced53009b6))
* **workflow:** remove trigger page and add it to workflow ([8619408](https://github.com/jat10/zaq/commit/86194085c1115837826d96a0bb200561f5ce97a4))
* **workflows:** add start namespace for trigger-to-first-node mapping ([1926c08](https://github.com/jat10/zaq/commit/1926c087d119c290a4b119ef0847022be0293c8a))
* **workflows:** handle temporarily added events in triggers add popin - fixes [#514](https://github.com/jat10/zaq/issues/514) ([2097d1b](https://github.com/jat10/zaq/commit/2097d1badd77e33a11a523accca90930362ba8ac))
* **workflows:** make map an internal-only node type, author iteration via Batch ([9a1bd51](https://github.com/jat10/zaq/commit/9a1bd517510c97939f30ead2b1dccfd5943baed9))


### Performance Improvements

* **Data source:** Avoid N+1 queries on Record Authorization ([a741cd7](https://github.com/jat10/zaq/commit/a741cd7a5bb76295f46e33cc0d63f9ada8e1c668))
* **e2e:** parallelize CI by browser and mint BO sessions directly ([55cf7f8](https://github.com/jat10/zaq/commit/55cf7f88c7442140469b3988f8e11cf78f9c4c7c))
* **storage:** batch permissions and ancestors load to avoid N+1 queries ([ce231f8](https://github.com/jat10/zaq/commit/ce231f888b33487a46e3b0b4ea945379d54028b6))


### Refactoring

* **Action:** shift update_document to record with `provenance_ref` ([ff5413f](https://github.com/jat10/zaq/commit/ff5413fc994eb64999d92797aed3defb9b31ebf0))
* **actions:** integrate code review comments for securing resource query and batch action migration to zoi schema ([4ff7452](https://github.com/jat10/zaq/commit/4ff7452894da9e6ebcb4f32829477974e7c82d10))
* **Actions:** introduce the materialization event to lazily download documents from Data sources ([b823d85](https://github.com/jat10/zaq/commit/b823d8558e1b5c8267bb326abd0e561a6d7be568))
* **Actions:** Make sure to enforce permissions for notify user action reusing query resource permission check ([b4f930f](https://github.com/jat10/zaq/commit/b4f930f5b643e4e630c25d73f06629605c5a494b))
* **actions:** refocus the encoding and decoding actions and remove additional unsollicited computations ([001c022](https://github.com/jat10/zaq/commit/001c022b1b40016480883590daad3f18253e9769))
* **actions:** removed dead code and add tests to cover more cases in update person action ([ba10a39](https://github.com/jat10/zaq/commit/ba10a39d08b851ad8123ef059691bc8d06817103))
* **agent:** convert base64 action schemas from nimble to zoi ([bf1c014](https://github.com/jat10/zaq/commit/bf1c01419a5b9d1b839464e366a8e2575fd0a230))
* **agent:** convert http_request schema from nimble to zoi ([2d45f95](https://github.com/jat10/zaq/commit/2d45f950740390774eefb77e5302e3f40ae94b07))
* **agent:** reference workflow agent by id via channel selection path ([55201f5](https://github.com/jat10/zaq/commit/55201f5284f7d9c5c0b5aaba39f368b207c346a9))
* **agent:** remove legacy skill prompts and inert limits ([3aada7c](https://github.com/jat10/zaq/commit/3aada7c8ed4e66858d6461c8b808e8503ba18871))
* **agent:** resolve workflow agent selection on agent node ([31d1e6a](https://github.com/jat10/zaq/commit/31d1e6afc7de9e5e112de53d986e7a5319136ba6))
* **agent:** reuse telemetry field sourcing, revert trace id suffix ([cb4acdb](https://github.com/jat10/zaq/commit/cb4acdbd77ab50e54ff5045f6214fb05a7a1e7ec))
* **agent:** seed run_agent context via opts as prebuilt AIContext ([457a27c](https://github.com/jat10/zaq/commit/457a27c9cc12a5a590d5429b2d1d46936c819fe7))
* **Agents:** map Record data to ContentParts in after_tool_call callback for agent consumption, adapt server_ref for correct short handle retrieval ([1515727](https://github.com/jat10/zaq/commit/1515727a738368770c7af1bd0bb4ddece188fb9b))
* **AI providers:** align UI and data feeding for updated management and design system component use ([7b4af7b](https://github.com/jat10/zaq/commit/7b4af7bcfdaadb6645ca6df95bc6e1a94d866122))
* **bo:** add CardShell and adopt on channels hub cards ([b76f617](https://github.com/jat10/zaq/commit/b76f617e39b072a0320ff810da6c411ebeb3a2b0))
* **bo:** add Drawer component and migrate Agents create/edit to slide-over panel. ([056aa8c](https://github.com/jat10/zaq/commit/056aa8cfc0f4c0741dff4dc54e1ed7542b304979))
* **bo:** add page breadcrumb DS component for workflow pages ([879fac8](https://github.com/jat10/zaq/commit/879fac8d80b70e01211763ac233ffe9456f3f1b5))
* **bo:** add scroll_max presets and wrapper_class to Table ([b8ba66d](https://github.com/jat10/zaq/commit/b8ba66db546b58c1cdcf80b7254f1775a30c62c2))
* **bo:** align history toolbar with ingestion and row-click navigation ([888a882](https://github.com/jat10/zaq/commit/888a882f07a2a3c2798d514d6a75ec48c622cbbd))
* **bo:** apply design system to login and password flows ([1c817e9](https://github.com/jat10/zaq/commit/1c817e95980cf04ecceb262825e5839f1a8bd6b1))
* **bo:** complete People master pane design-system migration ([b882cc0](https://github.com/jat10/zaq/commit/b882cc0e75d402d05143b06b2a9c2b1028578a43))
* **bo:** default tables to non-scrollable page layout ([47244df](https://github.com/jat10/zaq/commit/47244dff221826e7c5d4962017b9849a8889c397))
* **bo:** design, increase contrast in dark mode ([09229fb](https://github.com/jat10/zaq/commit/09229fb397dae8bcbb454d7f7b27f91a3c68acc2))
* **bo:** extract agents table and migrate section wrapper to zaq styles ([f66d685](https://github.com/jat10/zaq/commit/f66d685cc3ca3a03bbfd2fcd4bd6c5a8a611bb85))
* **bo:** extract DesignSystem.Switch for form boolean toggles ([3bb2c8d](https://github.com/jat10/zaq/commit/3bb2c8dc2196c2411b4803abec6fd5b7cd8fcdd3))
* **BO:** leverage the new incoming message router when picking agent in the Chat page ([42db851](https://github.com/jat10/zaq/commit/42db8515984fa1552ab5dc002e439370366c262c))
* **bo:** migrate BOModal form_dialog to token-backed modal shell ([f472432](https://github.com/jat10/zaq/commit/f4724323e8509dec3fcd29bedc522bb363ef7379))
* **bo:** migrate change password to design system ([dc783b0](https://github.com/jat10/zaq/commit/dc783b022585781424b419a6a163bf2cbb39dbbc))
* **bo:** migrate channels hub UI and ghost back navigation ([81b0bed](https://github.com/jat10/zaq/commit/81b0bed0583acb7a3dc392dfeca37d131fb7752f))
* **bo:** migrate dashboard services table to DesignSystem.Table ([90e1211](https://github.com/jat10/zaq/commit/90e1211c02ce043382d8472fb07d1f078b724266))
* **bo:** migrate feedback modal to DS and add secondary pill active ([c41029f](https://github.com/jat10/zaq/commit/c41029fecbb70a119e571a28849264fb47c594d6))
* **bo:** migrate history status and channel filters to compact selects ([5ee8168](https://github.com/jat10/zaq/commit/5ee8168d7a695d7a316fb9bd94e92b95279f707a))
* **bo:** migrate ingestion file browser to DesignSystem.Table ([dac7e14](https://github.com/jat10/zaq/commit/dac7e149442ff458b84dc821ccbb797873800583))
* **bo:** migrate people list to DS table components ([914f8c6](https://github.com/jat10/zaq/commit/914f8c6c805ee9aaec96e4075a794408e408ca59))
* **bo:** migrate workflow detail and run detail page headers ([1188223](https://github.com/jat10/zaq/commit/118822310afe6b3356eda3017a2373fe0c268d6d))
* **bo:** move ingestion jobs panel into a right drawer ([089f304](https://github.com/jat10/zaq/commit/089f3043c443395b0f7113eb4e167d2bf5959d47))
* **bo:** move ingestion upload into BOModal and stack chrome bands ([9bae55e](https://github.com/jat10/zaq/commit/9bae55eaf41036d4d34739fef0304ff4702df011))
* **bo:** move page titles and subtitles into BOLayout header ([3b39124](https://github.com/jat10/zaq/commit/3b39124838365dfd5abdcba55c1ae0f7e5a360c6))
* **bo:** move Skills form to drawer and close on create ([a46ae6d](https://github.com/jat10/zaq/commit/a46ae6dcfb4b8cfdcd3a84e0ccae8bc8c3e7d55e))
* **bo:** rename add-action buttons and align plus icon ([41d398d](https://github.com/jat10/zaq/commit/41d398dabfb7dfde6d546f4855c924048681085e))
* **bo:** replace buttons in workflow detail page ([47d850b](https://github.com/jat10/zaq/commit/47d850ba5496407a3615e85d7f70c7acd1f4aa02))
* **bo:** replace chat agent select with SearchableSelect ([7a80fc5](https://github.com/jat10/zaq/commit/7a80fc509c6b5427dfb671e8bb5c9378a00ac674))
* **bo:** replace ingestion job status chips with Toggle ([358d867](https://github.com/jat10/zaq/commit/358d867cefc4c44b2c09a61b4b5c409200dd5941))
* **bo:** replace table to DS component ([21582f3](https://github.com/jat10/zaq/commit/21582f3932b88d29e98545c476dce51a3287bb15))
* **bo:** replace users table with DesignSystem.Table ([d633b1e](https://github.com/jat10/zaq/commit/d633b1e27bbd5d4ca5ee58ed01a8401859a7d2a6))
* **bo:** replaced table of runs in workflow detail page to use DS ([17c96a2](https://github.com/jat10/zaq/commit/17c96a2cc312e5f679b1e10472229f8db42b282a))
* **bo:** show action buttons on hover in the table of history page ([13d48f2](https://github.com/jat10/zaq/commit/13d48f27f3c218a208b76c9bcd4570711aeb6557))
* **bo:** streamline ingestion file browser toolbar layout ([160f61e](https://github.com/jat10/zaq/commit/160f61e7e6097044a4e144b6ce4c7b774af34cbd))
* **bo:** tokenize SimplePagination and migrate People tabs to Toggle ([28b7135](https://github.com/jat10/zaq/commit/28b713500df4839b77de5ae3fadebdc1baadee0b))
* **bo:** unify BOModal header across shell and dialog variants ([bebad47](https://github.com/jat10/zaq/commit/bebad471b5d9547e8a19fa6c90730d63460f07bc))
* **bo:** unify ingestion sources in Toggle with channel icons ([c83af29](https://github.com/jat10/zaq/commit/c83af293c162f42cb581e4b4f7d9383b5bf1a866))
* **bo:** unify password policy UI and field hints on DS inputs ([ce555d7](https://github.com/jat10/zaq/commit/ce555d73930d0e91b5fe4c8305cccec69badad78))
* **bo:** unify upload modals via ModalUpload for workflow import ([f2ebc3a](https://github.com/jat10/zaq/commit/f2ebc3a8d73e708044459ca59bfb5a8e968ca0ac))
* **bo:** use component labels on history filters and improve select layout ([954c713](https://github.com/jat10/zaq/commit/954c713ef5ec2854b0b89878f18104186f031780))
* **bo:** wire Agents drawer footer to DesignSystem.Button ([641a077](https://github.com/jat10/zaq/commit/641a0777cb3fcdadaebeebe540f45d49e748c0e2))
* **bo:** wire Skills page buttons to DesignSystem.Button ([5ac2acb](https://github.com/jat10/zaq/commit/5ac2acbcbeff22e672567855ab511de1d9e660e3))
* **channels:** compute conversation identity and SMTP delivery channel-side ([27ff1ed](https://github.com/jat10/zaq/commit/27ff1ed62e5e50ea71fe254a923d56090d146217))
* **channels:** keep telegram rich-message format out of the bridge ([10174d0](https://github.com/jat10/zaq/commit/10174d08261ab9b9b505f65e61a885a24288cab3))
* **channels:** move email threading mechanics into EmailBridge ([a1bac47](https://github.com/jat10/zaq/commit/a1bac47230afa05d5f1307fc77458860442c5b80))
* **channels:** move HttpRequest struct to top-level Zaq.HttpRequest ([7481e3a](https://github.com/jat10/zaq/commit/7481e3aed10e89449b189df485b996d0b78a7d8c))
* **channels:** re-align code with new person/actor modules ([f5a8869](https://github.com/jat10/zaq/commit/f5a88698463a2f42fc9fb5dfba9fd1d529388e64))
* **channels:** route reactions through Chat and unify rating path ([19b44b2](https://github.com/jat10/zaq/commit/19b44b2bbe607555cddd28176bba8ac0827c88aa))
* **channels:** store single generic threading anchor, drop email residue ([1663e9e](https://github.com/jat10/zaq/commit/1663e9e55a796f4c5b2d53914141db626d3885b8))
* code review comments ([3f8a704](https://github.com/jat10/zaq/commit/3f8a704f1231af64ee031cbc882a6986e84554e2))
* **code:** code review comments integration ([9e5d39a](https://github.com/jat10/zaq/commit/9e5d39af95390152e15800869b518774389ee983))
* **communication channels:** Centralize Incoming message routing rules inside engine, resolve person identity in engine ([e4c0c73](https://github.com/jat10/zaq/commit/e4c0c7369baaec018b18fecd2c92c4b362088f71))
* **Communication:** setup new Record materialization handlers ([1515727](https://github.com/jat10/zaq/commit/1515727a738368770c7af1bd0bb4ddece188fb9b))
* **credentials:** contract-hardening for people's credentials ([d8562b2](https://github.com/jat10/zaq/commit/d8562b25afeb8d94c72cde84f0694cf80b462cd7))
* **credentials:** credentials storage with mutations for atomic policy saves ([670e0a5](https://github.com/jat10/zaq/commit/670e0a5c7a5f434013f412d0cb00a2316f2aff1f))
* **credentials:** update credential schema to support person owned grants ([563b1bb](https://github.com/jat10/zaq/commit/563b1bbc51617504faa5907ffa9f5c017fdeb6bf))
* **data source:** hardening code standards for permission checks ([ec9811d](https://github.com/jat10/zaq/commit/ec9811d16e715bd56a67baaa109521a3f93d8da1))
* **Data source:** introduce a provenance token to sign key record fields for sensitive actions ([bcaf2d3](https://github.com/jat10/zaq/commit/bcaf2d3801d219a6b36b786bfd586aaf080b05a2))
* **Data source:** provenance token to provenance ref to avoid Jido.AI redaction. Remove parent_ids and updated_at fields from provenance signature. Include provenance_ref in opaque alias to avoid transcription errors ([1f558ce](https://github.com/jat10/zaq/commit/1f558cec770e142008c6565fda4d591bb51544ac))
* **data source:** remove the materializer from data source tool ([8a36196](https://github.com/jat10/zaq/commit/8a361969be848451f27e45b1af6367f8b04e86e4))
* design changes to btn tertiary ([565ba30](https://github.com/jat10/zaq/commit/565ba30b7b6be00339888540a7b3f7fe5c8dbce1))
* design update of BO_layout title class ([6223c6a](https://github.com/jat10/zaq/commit/6223c6adbfa44987b6c63adfd49e4aa7c2b4b11e))
* **design:** migrate ingestion status timestamps to table_datetime ([ad02d2c](https://github.com/jat10/zaq/commit/ad02d2c269a35288a23f7e14ec8e29589fb92636))
* **Disk:** migrate file operations into new disk data source ([97d34ea](https://github.com/jat10/zaq/commit/97d34eae6a8ad27f2e7a888299720506e4c1c70f))
* **ds:** apply zaq-text-body to Toggle segment labels ([6658e3f](https://github.com/jat10/zaq/commit/6658e3f6f8a2ef6e9f279b9ebe4aa5bd6685e8fc))
* **e2e:** use regular login flow for authentication ([ffb2e5c](https://github.com/jat10/zaq/commit/ffb2e5c7c74a4b7c80eab48bba2c06d1cb93b211))
* **engine:** decompose workflow tools and run contract per PR [#430](https://github.com/jat10/zaq/issues/430) ([1e13c22](https://github.com/jat10/zaq/commit/1e13c2298950a25af846f47f46acbc32d4c78b4f))
* **engine:** inject dependencies to make workflow modules testable ([46215b8](https://github.com/jat10/zaq/commit/46215b89e4949cdd1ce0a19cc866def69fee0ccd))
* **engine:** revert google tool namespaces, rename StepApproval, dispatch via NodeRouter ([f5f4fc0](https://github.com/jat10/zaq/commit/f5f4fc07293dcfc23e0be9f29289ddb69fe04b82))
* **factory:** simplify callback implementation to avoid credo findings ([6adac1e](https://github.com/jat10/zaq/commit/6adac1e0a960d6a2277c8fe5d28e5f5016f396c1))
* **helpers, comments:** use helper function to avoid redeclaring shared utils, added docs to clarify intent ([a9ed457](https://github.com/jat10/zaq/commit/a9ed457d5f9bd191168d5097993b5c3d33a87589))
* **http_request:** correct the node boundaries violation, remove test related backdoor in req options ([5b41f25](https://github.com/jat10/zaq/commit/5b41f254fb5d43e4eaeced720072e01be519b08a))
* implement code changes based on PR review ([b2869af](https://github.com/jat10/zaq/commit/b2869afab39f94d9e0a38a2e96a707fd1e361c79))
* implement code review comments to add global helper and document intent ([e5792cd](https://github.com/jat10/zaq/commit/e5792cda6ebc8ca59a46555a088e5eebfba5b82b))
* implement code reviews findings ([385b200](https://github.com/jat10/zaq/commit/385b2006047bd3cd2e71917369bb9eb769c892f1))
* increase DRY on metadata_value map, make codex oauth app id configurable ([7b47bb6](https://github.com/jat10/zaq/commit/7b47bb626951ede10c30eafe1b5790a08647a52c))
* **ingestion,ui:** code review on ingesting daya source files ([dede25d](https://github.com/jat10/zaq/commit/dede25dc1508a31e3f847bf616fbdace9f91acdf))
* **ingestion:** drop start_offset/end_offset chunk locators ([dd03de5](https://github.com/jat10/zaq/commit/dd03de56010754e9753022315283e06f13de1ae6))
* **ingestion:** drop unused chunk id field from chunk struct and payload ([64498cb](https://github.com/jat10/zaq/commit/64498cb78160021362f203b7eff9803c14f34bd1))
* **Ingestion:** finalize ingestion transition from hardcoded disk to data source driven display ([90c25df](https://github.com/jat10/zaq/commit/90c25dffdca6db8e7fcbbe0e1374611ea5d238d1))
* **ingestion:** materialize disk records via signed handle ([d3c43df](https://github.com/jat10/zaq/commit/d3c43df54996999baab789d20c62881acf1238b5))
* **ingestion:** N+1 in permissions fetching and edge case handling ([0c70ab9](https://github.com/jat10/zaq/commit/0c70ab94e5dbf0ed32648b0e482e836aa428344c))
* **ingestion:** name disk records by source, drop record shaping ([c2f8626](https://github.com/jat10/zaq/commit/c2f8626bd8c1d23861d2329f0359bd821af0a1cb))
* **ingestion:** remove sidecar specific code with cleanup migration ([514f3bb](https://github.com/jat10/zaq/commit/514f3bbd04eaef9a57806f3b7a1364e6580024ef))
* **ingestion:** rename materialize_record action to materialize_document ([96669a3](https://github.com/jat10/zaq/commit/96669a38833c6fcd946a366dbf20fbe024f169b7))
* **ingestion:** type explorer entries, extract identity resolution ([5090945](https://github.com/jat10/zaq/commit/50909457e3da37d5c7d8783b55eaef6dad413160))
* **ingestion:** update phoenix_live_view to fix test-harness, increase coverage on ingestion live page ([09b071c](https://github.com/jat10/zaq/commit/09b071c0e297516fbdac0c0cdcc3b7b9468fd697))
* **live:** migrate agents and skills BO pages to zaq design tokens ([988e43e](https://github.com/jat10/zaq/commit/988e43eca2ec163d0f0411602eb60cdbb5f9e6b6))
* **message_routing:** add an upsert rules method in the context, add an action to invoke the new upsert rules ([c3f84b5](https://github.com/jat10/zaq/commit/c3f84b58a5743f343b6398cca5500c5ca1fcb176))
* **message_routing:** implement approved code review changes ([ae599e6](https://github.com/jat10/zaq/commit/ae599e6f355f3ebf1ee853b6b18eccadb0e071cc))
* **message_routing:** re-align message names with new engine message router ([0122831](https://github.com/jat10/zaq/commit/01228314c40e7f173216e693dc9b1b7c30331269))
* **migrations:** move dba with create extensions outside migrations to run with no superuser ([cd7016a](https://github.com/jat10/zaq/commit/cd7016ad63bddc289b1d0f67e60e33119fe67c3f))
* move reaction-to-rating mapping into JidoChatBridge ([345b848](https://github.com/jat10/zaq/commit/345b848d3df8a536d603050a73f9f1417a016b3c))
* **NodeRouter:** continue migrating code for removal of call/4 and call/5 ([a54e7c4](https://github.com/jat10/zaq/commit/a54e7c47263bb5a3c326092dc7910d6d8c6afa9d))
* **notification:** move notification from async to inline ([15bfb6c](https://github.com/jat10/zaq/commit/15bfb6ce710fa3994a7cf1acebf8b386235cce71))
* **people:** align sign-in page with BO AuthLayout shell ([e2acd2d](https://github.com/jat10/zaq/commit/e2acd2de09068a7a6066839ab987fa8fffc96c0d))
* **People:** Document merge locks and dedicate changeset for merge updates ([ffa0ba0](https://github.com/jat10/zaq/commit/ffa0ba0e44bf9928c6fb4e40509246f5c84182a9))
* **people:** properly separate boundaries in code and tighten logout ([db5c0f8](https://github.com/jat10/zaq/commit/db5c0f8b7763d8f31d659f2ab9a9ac8cec17fe2c))
* **people:** reuse shared card shell (zaq-xz1) ([70311b8](https://github.com/jat10/zaq/commit/70311b881afbfe49df00f101dd48e720ac1b7a89))
* **permissions:** move public permissions into global resource permission module, remove document tags for public share ([425e57a](https://github.com/jat10/zaq/commit/425e57a8c049b9fa9bf60fc179c5ab7061c972d3))
* **Record:** materialize records via handle, use new Jido.AI callbacks to let agent deal with short handles and avoid LLM transcription errors ([92cffd7](https://github.com/jat10/zaq/commit/92cffd7de67683384e758ed2116f37dc1340512a))
* reduce duplicate codes flagged by ex_dna ([fc54e75](https://github.com/jat10/zaq/commit/fc54e7526caea8a560e947a52098ac4db1f21676))
* remove deprecated compatibility APIs ([a57df5b](https://github.com/jat10/zaq/commit/a57df5bbe8ebf2394f31e5262493ea2ed4ac8334))
* remove unnecessary slop in Bridge, make ChannelConfig return standard provider for config ([7b31351](https://github.com/jat10/zaq/commit/7b313513eb26a100ffec140e3b0e9a983977cfed))
* reorganize reaction rating flow ([518b7d0](https://github.com/jat10/zaq/commit/518b7d0a54dcedbe8534a5f9a274a74409d11e20))
* **skills:** access resources through the disk bridge ([4a0da38](https://github.com/jat10/zaq/commit/4a0da3838f03d9d6f23d517c79ce9548e1feb985))
* **storybook:** add live chart previews to Charts story ([08a0381](https://github.com/jat10/zaq/commit/08a0381ebd8194577197cb52133aeb183627ee3a))
* **storybook:** migrate BOModal previews and consolidate modal stories ([0b32641](https://github.com/jat10/zaq/commit/0b32641232211de4467756e26e92f941b9f30a73))
* **storybook:** move Empty State and Embedding Banner stories ([b24f37f](https://github.com/jat10/zaq/commit/b24f37fd2cbf24798f8cdd8827a907482587ab11))
* **storybook:** update BOModal form_dialog and iframe previews ([d96e0ea](https://github.com/jat10/zaq/commit/d96e0eafd9e816407a4b5ec64b521e108799b064))
* **test:** isolate dependencies for branch testing ([7cb35b3](https://github.com/jat10/zaq/commit/7cb35b3c2edc3296547fb45c6a94dd4bdd6a3642))
* **test:** share integration agent lifecycle setup ([08cebe3](https://github.com/jat10/zaq/commit/08cebe39fa4407511b6c6f701c0ed82a996280b1))
* **web:** drop UploadFlash, report skill uploads via overlay toast ([7e73969](https://github.com/jat10/zaq/commit/7e7396948e2afbf3cb59b42f7b2315ea42076ae2))
* **web:** extract agent trace panel into dedicated component ([17e5d24](https://github.com/jat10/zaq/commit/17e5d24a8f780d6d8522435b0d03624180fc020e))
* **web:** fold skill resource modal into ModalUpload behind opt-in props ([50da604](https://github.com/jat10/zaq/commit/50da604667a786c266feb8eeaa86e812d0708ccc))
* **workflow:** revert changes on update_sheet_values and support concat action ([1f0f924](https://github.com/jat10/zaq/commit/1f0f9248a46db0987ba9f6a1171e8633ed93da8a))
...
* **Action:** Delete document action ([c3a4a71](https://github.com/www-zaq-ai/zaq/commit/c3a4a7172aa3a69a401e505217cae54335890da2))
* **action:** expose a workflow and agent action to update message routing rules ([53703ed](https://github.com/www-zaq-ai/zaq/commit/53703ed09dcc43bece9c0ffc31a52c482eafe9b4))
* **Actions:** add a new action to notify BO users ([1d6ed08](https://github.com/www-zaq-ai/zaq/commit/1d6ed088ddcdb62f4c161dc9459c71504aaeb8bf))
* **actions:** add a new action to query whitelisted resources with specific fields exposure for secure access ([e638435](https://github.com/www-zaq-ai/zaq/commit/e6384354f0f1859dd5c4939653b198c91a704a67))
* **actions:** add the channels config to the query resource tool ([64c34bd](https://github.com/www-zaq-ai/zaq/commit/64c34bd0cb7c35d8f997c32f9499accf496b6e72))
* **actions:** conver ensure_person schema to ZOI, expose it to the tools registry for agent/skills discovery ([2098dcf](https://github.com/www-zaq-ai/zaq/commit/2098dcff6b435b4091e8dea0b75d3f13dda5ebb2))
* **Action:** secure http request with configuration, define an http credential provider to leverage auth credentials for authenticated requests ([96a2c60](https://github.com/www-zaq-ai/zaq/commit/96a2c60c9f4a51c0901ebfb573291c27fe16f053))
* **actions:** update a person info and/or channels with merge ability ([3ce8592](https://github.com/www-zaq-ai/zaq/commit/3ce85922898d81c8dcf2437ee149287cb1313384))
* **Agent Skills:** migrate custom code to Jido.AI.Skill and support Skill resources ([ca7b695](https://github.com/www-zaq-ai/zaq/commit/ca7b6959a1634a21ec7837d828d49e5732666ddb))
* **Agent Skill:** support binary resources ([54523f8](https://github.com/www-zaq-ai/zaq/commit/54523f8522de0ce7ef223093442c2e3206abc38b))
* **agent:** add encode_base64 and decode_base64 tools ([2722408](https://github.com/www-zaq-ai/zaq/commit/2722408e2e16d67f126b55afe16650b8e4e578f3))
* **agent:** add encode_json and decode_json tools ([9524ae4](https://github.com/www-zaq-ai/zaq/commit/9524ae4f7b426a8a4f77e9cbd58b0d69f0caf139))
* **agent:** support base64 files and canonical folders ([75392d9](https://github.com/www-zaq-ai/zaq/commit/75392d9ec9f91bd75ca7f85c87bda95835cdcc43))
* **bo:** manage disk provider volumes ([237f76b](https://github.com/www-zaq-ai/zaq/commit/237f76b0200934ed42c16ac3e878710ae9707b84))
* **bo:** unify history feedback modal with chat ([b238dd7](https://github.com/www-zaq-ai/zaq/commit/b238dd76603d1edd65ccb34e7b9b7738abb9fcde))
* **channels:** add disk data-source bridge over ingestion volumes ([4f95fec](https://github.com/www-zaq-ai/zaq/commit/4f95fec4b7e7c24914f7951b186cef5c34c21605))
* **channels:** add http_request action and general.http_request tool ([fba4659](https://github.com/www-zaq-ai/zaq/commit/fba46593ced57b77feb5d515a78248cd391767bb))
* **channels:** scope disk bridge operations to channel configs ([94191b2](https://github.com/www-zaq-ai/zaq/commit/94191b2a36985b0850340989b4a41a82b5712324))
* **contracts:** add materializing_event to record, excluded from json ([1fa22d0](https://github.com/www-zaq-ai/zaq/commit/1fa22d0624ad8fe6a97036223ff3bf90236b7a99))
* **data source:** enforce external data sources with provider's permissions and person's identity ([f05a55b](https://github.com/www-zaq-ai/zaq/commit/f05a55b50b167345eb201519908fd96641d610c0))
* **imap:** support attachments in incoming emails ([029d59a](https://github.com/www-zaq-ai/zaq/commit/029d59a2c366507b3893d058d1e1c2645e4d1384))
* **ingestion:** browse and preview materialized provider records ([43adafe](https://github.com/www-zaq-ai/zaq/commit/43adafe2f1967bcc496cc0159a33a8375fe0d056))
* **live:** add skill resource uploads backed by ingestion volumes ([c11dd04](https://github.com/www-zaq-ai/zaq/commit/c11dd049c602d8213064ef29a971b0a8d82a83d8))
* **live:** cap skill resource uploads and inline the resources panel ([185047d](https://github.com/www-zaq-ai/zaq/commit/185047d7047e30bae7c148bb02ca51211d2fdf86))
* **media:** Receive media from channels and relay to agent with proper logs ([342d6eb](https://github.com/www-zaq-ai/zaq/commit/342d6eb125a192bf24205de02be56025838022fc))
* **message_routing:** enable person based message routing ([7a788c5](https://github.com/www-zaq-ai/zaq/commit/7a788c5005221ba3e85e2bbf900b652e6b7c615f))
* **storage:** persist disk volumes in channel configuration ([987e791](https://github.com/www-zaq-ai/zaq/commit/987e791b9cb9bcb3fc6fccdc4a180335c0818dfb))


### Bug Fixes

* **agent:** allow private skill resource loading ([68aad62](https://github.com/www-zaq-ai/zaq/commit/68aad620231ea2e1305ce4837a175fc92bde0b74))
* **agent:** enable LuaEval with Lua runtime dependency ([8c6f12d](https://github.com/www-zaq-ai/zaq/commit/8c6f12ddb70acb086806cb583e668e2a6cee9d9f))
* **Agent:** enforce model max context size per turn ([8c77be5](https://github.com/www-zaq-ai/zaq/commit/8c77be5232c0f0da6936d9d60a1a9f0b084838d9))
* **agent:** handle binary content in context estimation ([794bbb5](https://github.com/www-zaq-ai/zaq/commit/794bbb517c7f56c97f72cf804ef4139ac67d642e))
* **Agent:** pass max context cfg to legacy answering agent ([966db9b](https://github.com/www-zaq-ai/zaq/commit/966db9b819de54cd022cf33c62f44caf53539061))
* **agent:** prevent filesystem discovery for DB-backed skills ([6691e54](https://github.com/www-zaq-ai/zaq/commit/6691e54f02e055e8c81ecfd6113f4b50fd88139a))
* **agent:** resolve skill resources by exact name ([f1446a2](https://github.com/www-zaq-ai/zaq/commit/f1446a228e9a124d35489be0f784e23a620595d7))
* **bo:** show bulk action bar when raw is selected and adjust history test ([0cf1220](https://github.com/www-zaq-ai/zaq/commit/0cf1220c58ece7b770c2c4f5b44a899585a4ffe8))
* **bo:** stop saved feedback note overlapping action buttons ([1a90dfc](https://github.com/www-zaq-ai/zaq/commit/1a90dfce102ebacb7fb1bcfe9f116ebd9e512bc0))
* **channels:** support Mattermost skin-tone reactions ([982d68a](https://github.com/www-zaq-ai/zaq/commit/982d68a7eeb26c52163a1b8db80dc7fa04cc3d62))
* **channels:** use provider roots and canonical folder ids for browsing ([840f629](https://github.com/www-zaq-ai/zaq/commit/840f6291d0384677796bb77644a6f8a46a58a2c8))
* **Data source:** get document on google drive use valid field mask ([623088e](https://github.com/www-zaq-ai/zaq/commit/623088e516d459a37248f00238e0ba9e2151b776))
* **data source:** seal watched records to make them safe for materialization ([2405f45](https://github.com/www-zaq-ai/zaq/commit/2405f456fa0ff8af604a36b21e12a01479f37a2a))
* **e2e:** history detail page is now open on clicking the raw of the table and not the view link ([3a06c5d](https://github.com/www-zaq-ai/zaq/commit/3a06c5d7649f3ad22b0446bfc52f0937331bf5db))
* **e2e:** login initial browsing session per env. ([13c0ef1](https://github.com/www-zaq-ai/zaq/commit/13c0ef137864d75cda33985087964996e26f0eca))
* **e2e:** stabilize async ingestion waits without drawer auto-open ([7c1edac](https://github.com/www-zaq-ai/zaq/commit/7c1edacfdaff64e61d5c486bb72c1a37808f17ce))
* **e2e:** target drawer Cancel button in agents cancel test ([db9de74](https://github.com/www-zaq-ai/zaq/commit/db9de7462d4732efe1cce0c53499d36987841f34))
* **e2e:** test ingestionStarted no longer waits for "Monitor jobs (1 active)  it now checks: "Ingestion started." toast appears. ([ef23f70](https://github.com/www-zaq-ai/zaq/commit/ef23f70aadf0b328d557ffb6a7c0f50aadc269c2))
* **email:** include subjet into Message.Incoming content for agents and conversation history ([8e06ccb](https://github.com/www-zaq-ai/zaq/commit/8e06ccbcf85b67d80919746376f1b1a5ac54bd9a))
* **google drive:** connect the new file upload action ([ad34aec](https://github.com/www-zaq-ai/zaq/commit/ad34aec4c5e836da08bf50a7f4cbbe5625b7f719))
* **Ingestion UI:** wiring to data source gaps ([613cd3b](https://github.com/www-zaq-ai/zaq/commit/613cd3b2bb9241f6d670e8b94eeb4f0d79439073))
* **ingestion:** diagnose rejected watch records ([33a6562](https://github.com/www-zaq-ai/zaq/commit/33a65624de05e8a5639c1331080fc063e7a527cc))
* **ingestion:** empty state when no data source is enabled, keep ingestion async for now and remove related controls from ui ([6553d44](https://github.com/www-zaq-ai/zaq/commit/6553d44a802334d604e24eb66487dfdb86a3b2aa))
* **ingestion:** keep runtime dependencies out of persisted jobs ([dfddd6d](https://github.com/www-zaq-ai/zaq/commit/dfddd6d6e403c414c40c2103e0628501983e25d2))
* **ingestion:** preserve materialization actor context ([97d9f4f](https://github.com/www-zaq-ai/zaq/commit/97d9f4f56cce8dfb15d985b41a74dff095d11ed5))
* **ingestion:** refresh file browser after async ingest enqueue ([a17bdce](https://github.com/www-zaq-ai/zaq/commit/a17bdce6a5e68e80fd27ef225aaf194361037d8e))
* **ingestion:** show ingest success as overlay toast above jobs drawer ([6655000](https://github.com/www-zaq-ai/zaq/commit/66550000809c96cc9925608fdb04a4b93273d423))
* **skills:** resolve uploads from current resource locations ([f862f7d](https://github.com/www-zaq-ai/zaq/commit/f862f7d697d1136e1463f2058471eaa11a9adf10))
* **storage:** align storage with existing data source actions for search, list and create documents ([0516fd3](https://github.com/www-zaq-ai/zaq/commit/0516fd384578134cfb11a4874a145137f54711ff))
* **storage:** enforce permissions on edit, move and delete documents ([1f607a2](https://github.com/www-zaq-ai/zaq/commit/1f607a2774f0e59fdbed92588f8b250e9ca7a6a7))
* **storage:** honor search paths and verify disk agent flow ([268298e](https://github.com/www-zaq-ai/zaq/commit/268298ecc16440ed62c69492c9cf2224feccb69a))
* **storage:** propagate actors and enforce disk entry permissions ([dbeaf34](https://github.com/www-zaq-ai/zaq/commit/dbeaf34e4044cb392a58cd717baa2f08e4fe3120))
* **storage:** properly count entry principals ([c633b70](https://github.com/www-zaq-ai/zaq/commit/c633b70576b06ecc19afd529f1ce58d6e948d9c2))
* **storage:** reject sibling path-prefix escapes ([8d14a12](https://github.com/www-zaq-ai/zaq/commit/8d14a12658b092438801fa45da8dac9255c57a29))
* **test:** eliminate suite warnings ([4e40503](https://github.com/www-zaq-ai/zaq/commit/4e40503eb495fa2fee9c65a682c17ad9df0732bb))
* **test:** format wait_for_idle_server guard clause ([78580a2](https://github.com/www-zaq-ai/zaq/commit/78580a2f4f2f4c9a76936573c5c19b7b6ad2bf1b))
* **test:** isolate batch trigger concurrency spec from PubSub pollution ([cbe6f27](https://github.com/www-zaq-ai/zaq/commit/cbe6f276e8c5ab3a339e5b268a5161b7fb43a88e))
* **test:** stabilize agent delete and IMAP listener sink error tests ([fbea05c](https://github.com/www-zaq-ai/zaq/commit/fbea05c0a15c238d33112881cbab4fa97166270b))
* **ui:** compute flash clear JS after default id is assigned ([d5e2590](https://github.com/www-zaq-ai/zaq/commit/d5e25905fe70de9e953618a8b502aa4d327d2f0f))
* **ui:** stabilize select dropdown sizing and panel positioning ([b44e4f1](https://github.com/www-zaq-ai/zaq/commit/b44e4f1aa7f3213d0558235761df9be711dcf329))


### Performance Improvements

* **Data source:** Avoid N+1 queries on Record Authorization ([a741cd7](https://github.com/www-zaq-ai/zaq/commit/a741cd7a5bb76295f46e33cc0d63f9ada8e1c668))
* **e2e:** parallelize CI by browser and mint BO sessions directly ([55cf7f8](https://github.com/www-zaq-ai/zaq/commit/55cf7f88c7442140469b3988f8e11cf78f9c4c7c))
* **storage:** batch permissions and ancestors load to avoid N+1 queries ([ce231f8](https://github.com/www-zaq-ai/zaq/commit/ce231f888b33487a46e3b0b4ea945379d54028b6))


### Refactoring

* **Action:** shift update_document to record with `provenance_ref` ([ff5413f](https://github.com/www-zaq-ai/zaq/commit/ff5413fc994eb64999d92797aed3defb9b31ebf0))
* **actions:** integrate code review comments for securing resource query and batch action migration to zoi schema ([4ff7452](https://github.com/www-zaq-ai/zaq/commit/4ff7452894da9e6ebcb4f32829477974e7c82d10))
* **Actions:** introduce the materialization event to lazily download documents from Data sources ([b823d85](https://github.com/www-zaq-ai/zaq/commit/b823d8558e1b5c8267bb326abd0e561a6d7be568))
* **Actions:** Make sure to enforce permissions for notify user action reusing query resource permission check ([b4f930f](https://github.com/www-zaq-ai/zaq/commit/b4f930f5b643e4e630c25d73f06629605c5a494b))
* **actions:** refocus the encoding and decoding actions and remove additional unsollicited computations ([001c022](https://github.com/www-zaq-ai/zaq/commit/001c022b1b40016480883590daad3f18253e9769))
* **actions:** removed dead code and add tests to cover more cases in update person action ([ba10a39](https://github.com/www-zaq-ai/zaq/commit/ba10a39d08b851ad8123ef059691bc8d06817103))
* **agent:** convert base64 action schemas from nimble to zoi ([bf1c014](https://github.com/www-zaq-ai/zaq/commit/bf1c01419a5b9d1b839464e366a8e2575fd0a230))
* **agent:** convert http_request schema from nimble to zoi ([2d45f95](https://github.com/www-zaq-ai/zaq/commit/2d45f950740390774eefb77e5302e3f40ae94b07))
* **agent:** remove legacy skill prompts and inert limits ([3aada7c](https://github.com/www-zaq-ai/zaq/commit/3aada7c8ed4e66858d6461c8b808e8503ba18871))
* **Agents:** map Record data to ContentParts in after_tool_call callback for agent consumption, adapt server_ref for correct short handle retrieval ([1515727](https://github.com/www-zaq-ai/zaq/commit/1515727a738368770c7af1bd0bb4ddece188fb9b))
* **bo:** add Drawer component and migrate Agents create/edit to slide-over panel. ([056aa8c](https://github.com/www-zaq-ai/zaq/commit/056aa8cfc0f4c0741dff4dc54e1ed7542b304979))
* **bo:** add page breadcrumb DS component for workflow pages ([879fac8](https://github.com/www-zaq-ai/zaq/commit/879fac8d80b70e01211763ac233ffe9456f3f1b5))
* **bo:** add scroll_max presets and wrapper_class to Table ([b8ba66d](https://github.com/www-zaq-ai/zaq/commit/b8ba66db546b58c1cdcf80b7254f1775a30c62c2))
* **bo:** align history toolbar with ingestion and row-click navigation ([888a882](https://github.com/www-zaq-ai/zaq/commit/888a882f07a2a3c2798d514d6a75ec48c622cbbd))
* **bo:** default tables to non-scrollable page layout ([47244df](https://github.com/www-zaq-ai/zaq/commit/47244dff221826e7c5d4962017b9849a8889c397))
* **bo:** extract DesignSystem.Switch for form boolean toggles ([3bb2c8d](https://github.com/www-zaq-ai/zaq/commit/3bb2c8dc2196c2411b4803abec6fd5b7cd8fcdd3))
* **BO:** leverage the new incoming message router when picking agent in the Chat page ([42db851](https://github.com/www-zaq-ai/zaq/commit/42db8515984fa1552ab5dc002e439370366c262c))
* **bo:** migrate feedback modal to DS and add secondary pill active ([c41029f](https://github.com/www-zaq-ai/zaq/commit/c41029fecbb70a119e571a28849264fb47c594d6))
* **bo:** migrate history status and channel filters to compact selects ([5ee8168](https://github.com/www-zaq-ai/zaq/commit/5ee8168d7a695d7a316fb9bd94e92b95279f707a))
* **bo:** migrate workflow detail and run detail page headers ([1188223](https://github.com/www-zaq-ai/zaq/commit/118822310afe6b3356eda3017a2373fe0c268d6d))
* **bo:** move ingestion jobs panel into a right drawer ([089f304](https://github.com/www-zaq-ai/zaq/commit/089f3043c443395b0f7113eb4e167d2bf5959d47))
* **bo:** move page titles and subtitles into BOLayout header ([3b39124](https://github.com/www-zaq-ai/zaq/commit/3b39124838365dfd5abdcba55c1ae0f7e5a360c6))
* **bo:** move Skills form to drawer and close on create ([a46ae6d](https://github.com/www-zaq-ai/zaq/commit/a46ae6dcfb4b8cfdcd3a84e0ccae8bc8c3e7d55e))
* **bo:** rename add-action buttons and align plus icon ([41d398d](https://github.com/www-zaq-ai/zaq/commit/41d398dabfb7dfde6d546f4855c924048681085e))
* **bo:** replace buttons in workflow detail page ([47d850b](https://github.com/www-zaq-ai/zaq/commit/47d850ba5496407a3615e85d7f70c7acd1f4aa02))
* **bo:** replace table to DS component ([21582f3](https://github.com/www-zaq-ai/zaq/commit/21582f3932b88d29e98545c476dce51a3287bb15))
* **bo:** replaced table of runs in workflow detail page to use DS ([17c96a2](https://github.com/www-zaq-ai/zaq/commit/17c96a2cc312e5f679b1e10472229f8db42b282a))
* **bo:** show action buttons on hover in the table of history page ([13d48f2](https://github.com/www-zaq-ai/zaq/commit/13d48f27f3c218a208b76c9bcd4570711aeb6557))
* **bo:** unify upload modals via ModalUpload for workflow import ([f2ebc3a](https://github.com/www-zaq-ai/zaq/commit/f2ebc3a8d73e708044459ca59bfb5a8e968ca0ac))
* **bo:** use component labels on history filters and improve select layout ([954c713](https://github.com/www-zaq-ai/zaq/commit/954c713ef5ec2854b0b89878f18104186f031780))
* **bo:** wire Agents drawer footer to DesignSystem.Button ([641a077](https://github.com/www-zaq-ai/zaq/commit/641a0777cb3fcdadaebeebe540f45d49e748c0e2))
* **bo:** wire Skills page buttons to DesignSystem.Button ([5ac2acb](https://github.com/www-zaq-ai/zaq/commit/5ac2acbcbeff22e672567855ab511de1d9e660e3))
* **channels:** move HttpRequest struct to top-level Zaq.HttpRequest ([7481e3a](https://github.com/www-zaq-ai/zaq/commit/7481e3aed10e89449b189df485b996d0b78a7d8c))
* **code:** code review comments integration ([9e5d39a](https://github.com/www-zaq-ai/zaq/commit/9e5d39af95390152e15800869b518774389ee983))
* **communication channels:** Centralize Incoming message routing rules inside engine, resolve person identity in engine ([e4c0c73](https://github.com/www-zaq-ai/zaq/commit/e4c0c7369baaec018b18fecd2c92c4b362088f71))
* **Communication:** setup new Record materialization handlers ([1515727](https://github.com/www-zaq-ai/zaq/commit/1515727a738368770c7af1bd0bb4ddece188fb9b))
* **data source:** hardening code standards for permission checks ([ec9811d](https://github.com/www-zaq-ai/zaq/commit/ec9811d16e715bd56a67baaa109521a3f93d8da1))
* **Data source:** introduce a provenance token to sign key record fields for sensitive actions ([bcaf2d3](https://github.com/www-zaq-ai/zaq/commit/bcaf2d3801d219a6b36b786bfd586aaf080b05a2))
* **Data source:** provenance token to provenance ref to avoid Jido.AI redaction. Remove parent_ids and updated_at fields from provenance signature. Include provenance_ref in opaque alias to avoid transcription errors ([1f558ce](https://github.com/www-zaq-ai/zaq/commit/1f558cec770e142008c6565fda4d591bb51544ac))
* **data source:** remove the materializer from data source tool ([8a36196](https://github.com/www-zaq-ai/zaq/commit/8a361969be848451f27e45b1af6367f8b04e86e4))
* **design:** migrate ingestion status timestamps to table_datetime ([ad02d2c](https://github.com/www-zaq-ai/zaq/commit/ad02d2c269a35288a23f7e14ec8e29589fb92636))
* **Disk:** migrate file operations into new disk data source ([97d34ea](https://github.com/www-zaq-ai/zaq/commit/97d34eae6a8ad27f2e7a888299720506e4c1c70f))
* **e2e:** use regular login flow for authentication ([ffb2e5c](https://github.com/www-zaq-ai/zaq/commit/ffb2e5c7c74a4b7c80eab48bba2c06d1cb93b211))
* **factory:** simplify callback implementation to avoid credo findings ([6adac1e](https://github.com/www-zaq-ai/zaq/commit/6adac1e0a960d6a2277c8fe5d28e5f5016f396c1))
* **http_request:** correct the node boundaries violation, remove test related backdoor in req options ([5b41f25](https://github.com/www-zaq-ai/zaq/commit/5b41f254fb5d43e4eaeced720072e01be519b08a))
* implement code changes based on PR review ([b2869af](https://github.com/www-zaq-ai/zaq/commit/b2869afab39f94d9e0a38a2e96a707fd1e361c79))
* implement code reviews findings ([385b200](https://github.com/www-zaq-ai/zaq/commit/385b2006047bd3cd2e71917369bb9eb769c892f1))
* **Ingestion:** finalize ingestion transition from hardcoded disk to data source driven display ([90c25df](https://github.com/www-zaq-ai/zaq/commit/90c25dffdca6db8e7fcbbe0e1374611ea5d238d1))
* **ingestion:** materialize disk records via signed handle ([d3c43df](https://github.com/www-zaq-ai/zaq/commit/d3c43df54996999baab789d20c62881acf1238b5))
* **ingestion:** name disk records by source, drop record shaping ([c2f8626](https://github.com/www-zaq-ai/zaq/commit/c2f8626bd8c1d23861d2329f0359bd821af0a1cb))
* **ingestion:** remove sidecar specific code with cleanup migration ([514f3bb](https://github.com/www-zaq-ai/zaq/commit/514f3bbd04eaef9a57806f3b7a1364e6580024ef))
* **ingestion:** rename materialize_record action to materialize_document ([96669a3](https://github.com/www-zaq-ai/zaq/commit/96669a38833c6fcd946a366dbf20fbe024f169b7))
* **ingestion:** type explorer entries, extract identity resolution ([5090945](https://github.com/www-zaq-ai/zaq/commit/50909457e3da37d5c7d8783b55eaef6dad413160))
* **ingestion:** update phoenix_live_view to fix test-harness, increase coverage on ingestion live page ([09b071c](https://github.com/www-zaq-ai/zaq/commit/09b071c0e297516fbdac0c0cdcc3b7b9468fd697))
* **message_routing:** add an upsert rules method in the context, add an action to invoke the new upsert rules ([c3f84b5](https://github.com/www-zaq-ai/zaq/commit/c3f84b58a5743f343b6398cca5500c5ca1fcb176))
* **message_routing:** implement approved code review changes ([ae599e6](https://github.com/www-zaq-ai/zaq/commit/ae599e6f355f3ebf1ee853b6b18eccadb0e071cc))
* **message_routing:** re-align message names with new engine message router ([0122831](https://github.com/www-zaq-ai/zaq/commit/01228314c40e7f173216e693dc9b1b7c30331269))
* **NodeRouter:** continue migrating code for removal of call/4 and call/5 ([a54e7c4](https://github.com/www-zaq-ai/zaq/commit/a54e7c47263bb5a3c326092dc7910d6d8c6afa9d))
* **permissions:** move public permissions into global resource permission module, remove document tags for public share ([425e57a](https://github.com/www-zaq-ai/zaq/commit/425e57a8c049b9fa9bf60fc179c5ab7061c972d3))
* **Record:** materialize records via handle, use new Jido.AI callbacks to let agent deal with short handles and avoid LLM transcription errors ([92cffd7](https://github.com/www-zaq-ai/zaq/commit/92cffd7de67683384e758ed2116f37dc1340512a))
* reduce duplicate codes flagged by ex_dna ([fc54e75](https://github.com/www-zaq-ai/zaq/commit/fc54e7526caea8a560e947a52098ac4db1f21676))
* remove deprecated compatibility APIs ([a57df5b](https://github.com/www-zaq-ai/zaq/commit/a57df5bbe8ebf2394f31e5262493ea2ed4ac8334))
* **skills:** access resources through the disk bridge ([4a0da38](https://github.com/www-zaq-ai/zaq/commit/4a0da3838f03d9d6f23d517c79ce9548e1feb985))
* **test:** isolate dependencies for branch testing ([7cb35b3](https://github.com/www-zaq-ai/zaq/commit/7cb35b3c2edc3296547fb45c6a94dd4bdd6a3642))
* **test:** share integration agent lifecycle setup ([08cebe3](https://github.com/www-zaq-ai/zaq/commit/08cebe39fa4407511b6c6f701c0ed82a996280b1))
* **web:** drop UploadFlash, report skill uploads via overlay toast ([7e73969](https://github.com/www-zaq-ai/zaq/commit/7e7396948e2afbf3cb59b42f7b2315ea42076ae2))
* **web:** fold skill resource modal into ModalUpload behind opt-in props ([50da604](https://github.com/www-zaq-ai/zaq/commit/50da604667a786c266feb8eeaa86e812d0708ccc))
