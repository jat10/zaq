...
## [1.0.0](https://github.com/jat10/zaq/compare/v0.17.0...v1.0.0) (2026-09-18)
...
* **datasources:** connect data source records to ingestion UI to list docs and navigate - phase 2 of [Ingestion] Generic UI for external Data Sources [#486](https://github.com/jat10/zaq/issues/486) ([3bc8ab3](https://github.com/jat10/zaq/commit/3bc8ab33c94187c51db14d9a69de7dc08d97a46b))
...
* **engine:** add batch field detection and scoped node preparation in dag builder ([94ca583](https://github.com/jat10/zaq/commit/94ca583e1d150144809f50944145acf4f1dc9374))
...
* **engine:** add human-in-the-loop approval flow with approve/reject run lifecycle ([d9cb2c5](https://github.com/jat10/zaq/commit/d9cb2c5b22350f193cfbba2b999679ba66df1e0c))
...
* **engine:** add trigger management API handler and list_triggers_with_workflows_and_recent_runs ([5efcd0b](https://github.com/jat10/zaq/commit/5efcd0bdeeabfcdfaa4360829dded081540b7faf))
...
* **engine:** cascade action results through workflow edges for cross-step conditions ([1b6345b](https://github.com/jat10/zaq/commit/1b6345b7873f18ca81d58919e112c94d0a6ea21d))
* **engine:** dispatch workflow lifecycle events via NodeRouter on run transitions ([07ee112](https://github.com/jat10/zaq/commit/07ee1124baf0be01f6e10d9dd304e3450b0fb3bc))
...
* **engine:** workflow engine improvements and Credo complexity fix ([8e953c1](https://github.com/jat10/zaq/commit/8e953c144be61bf2a5a6beb0f0a023c3fa0482c4))
...
* **live:** add triggers BO page with components, routing, and test coverage ([1af895b](https://github.com/jat10/zaq/commit/1af895bba1cbeda07759d8a5d87bd989e8395fb8))
...
* **live:** add workflow BO screens and action result input tracking ([f80fd66](https://github.com/jat10/zaq/commit/f80fd66ea4fae5fe60fb426c8190c7985bce28e0))
...
* **workflow:** add json tree hook and component, per-page selector, and status toggle ([6d838d1](https://github.com/jat10/zaq/commit/6d838d111dbe81e5d5c50c14dfcc6fd6a374612e))
* **workflows:** add BO pages for workflow list, detail, and run log trail ([81e88d7](https://github.com/jat10/zaq/commit/81e88d78e5c8d76e93e56e25c52fe6fc169d995e))
* **workflows:** add BO workflow pages with DAG visualisation, trigger icons, run/delete actions, and ([cc1e9b3](https://github.com/jat10/zaq/commit/cc1e9b34650fe8126c8b9a12560418e7f410774a))
* **workflows:** add cancellation support, structured run lifecycle, and BO run/detail UI improvements ([0c09373](https://github.com/jat10/zaq/commit/0c0937325f332bef45fe45f46caf5431a3a13a53))
* **workflows:** add conditional edge routing, action wrapper, and full test coverage ([34b4fe1](https://github.com/jat10/zaq/commit/34b4fe153393e621266d7aec114145cb92750c6b))
* **workflows:** add EdgeCondition.changeset/1 and consolidate condition validation ([97a030e](https://github.com/jat10/zaq/commit/97a030eebd206d3826b23aa0f22543821ca99df4))
* **workflows:** add HITL dag styling, trigger icon derivation, run-now button, and test coverage ([2d87a9a](https://github.com/jat10/zaq/commit/2d87a9a039134b053c2b4ef1d06b4ed5c007baa8))
* **workflows:** edges as conditional data-connector routes with full coverage ([3f4596e](https://github.com/jat10/zaq/commit/3f4596e421b283f69c61725d7d395ec71d5a4540))
...
* **engine:** register RunRegistry in supervisor and test helper ([6628ca7](https://github.com/jat10/zaq/commit/6628ca7d8eb06e3c29ed6cf76e5294cd401f13b9))
* **engine:** remove duplicate RunRegistry startup and fix related test warnings ([85c4444](https://github.com/jat10/zaq/commit/85c4444dea1b7facf1f222f911c434fbbe398ef4))
...
* add DesignSystem.Table list and grid with Storybook docs. ([78c8ffa](https://github.com/jat10/zaq/commit/78c8ffa4132fff8f90958bc7c7e0f53477da8ed6))
* add semantic layout spacing tokens and layout.css utilities ([bcc041e](https://github.com/jat10/zaq/commit/bcc041e5cb6ad61082c21a64181d3623c4db8473))
...
* consolidate BOModal Storybook docs with scrollable API reference ([7b8ee34](https://github.com/jat10/zaq/commit/7b8ee34e9deec12a4713c1183e60f572127d1465))
...
* **engine:** replace string-ref pipeline lookup with inline node maps in DagBuilder ([46b2621](https://github.com/jat10/zaq/commit/46b26214aa7c2add411eb1d111fa2233fd471e35))
...
* extract DesignSystem.Button with variants and loading ([1a4becc](https://github.com/jat10/zaq/commit/1a4becc9f03fa86cdb5de2f9c5086c8525f63f39))
* extract DesignSystem.Link with accent tone and storybook ([b783852](https://github.com/jat10/zaq/commit/b783852f3a485f21cceca0a16e805e0b07533120))
* extract DesignSystem.MetricCard with optional link maps ([f029728](https://github.com/jat10/zaq/commit/f029728d96cee0970ec4670c8aadedc241dbd735))
...
* improve Button story layout and icon rendering ([ad18338](https://github.com/jat10/zaq/commit/ad183385d36695f682e957d49409e7ed6eb0b1a6))
...
* isolate Storybook CSS in dev-only Tailwind build ([0569173](https://github.com/jat10/zaq/commit/0569173277c61735116b88ba5d3650a727d7c95a))
...
* migrate BOModal confirm_dialog to design system tokens ([2528984](https://github.com/jat10/zaq/commit/25289840c5d83f9e3b438227730546b18c828d8f))
* migrate checkbox component to design system tokens ([fdf4995](https://github.com/jat10/zaq/commit/fdf49953077153b4f7940fa48c324a455fdb9ffe))
...
* moving css classes to forms.css for cleaner documentation ([3f7f611](https://github.com/jat10/zaq/commit/3f7f611495629029015d9216cfb821a10eeffe8b))
...
* updating designs of input and select (including a compact version) ([d7fea4b](https://github.com/jat10/zaq/commit/d7fea4b498b928fd1f956857d4fe5ac97015a862))
...
* wire DesignSystem.Link into metric overview sub-metric CTAs ([f01d727](https://github.com/jat10/zaq/commit/f01d727b27bfd5d0d39721af3fed95704b616823))
* wire MetricOverview to DesignSystem.MetricCard ([122991b](https://github.com/jat10/zaq/commit/122991b07c03f40bb527e3ad2eaf9134a11a92de))
